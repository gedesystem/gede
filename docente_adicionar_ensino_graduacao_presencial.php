...
<section>
    ...
    <form method="post" action="bd_docente_adicionar_ensino_graduacao_presencial.php">

        <h2 class="Titulo">Adicionar Informação de Ensino de Curso de Graduação Presencial</h2>
