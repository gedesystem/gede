...
$sql_seleciona = "SELECT * FROM alunos_estagio WHERE matricula_uefs = '" . $matricula_uefs . "'";
...
<!--        <p>Matrícula do Aluno:<input type="text" class="form-control" required="required" name="nMatricula" pattern="[0-9]+$" placeholder="Número de matrícula na IES."></p>-->
        ...
        <p>Local de Trabalho:<input type="text" class="form-control" required="required" name="nLocalTrabalho" pattern="[A-Z\s]+$" placeholder="Local de trabalho do estágio. Utilize letras MAIÚSCULAS."
            value="<?php echo($res['local_trabalho']); ?>"></p>
