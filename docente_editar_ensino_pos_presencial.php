...
$sql_seleciona = "SELECT * FROM docentes_ensino_pos_presencial WHERE matricula_uefs = '" . $matricula_uefs . "'";
...
<section>
    ...
    <form method="post" action="bd_docente_editar_ensino_pos_presencial.php">

        <h2 class="Titulo">Editar Informações de Curso de Pós-Graduação Presencial de Docente</h2>
        ...
        <p>Início:
            <input type="text" class="form-control" id="iData" name="nData" required="required"
                   ...
                   placeholder="Data de início do curso de pós-graduação presencial, separada por barras. Ex: 01/05/2015."
