...
$especificacao = isset($_POST["nEspecificacao"]) ? $_POST["nEspecificacao"] : "";
$fonte = isset($_POST["nFonte"]) ? $_POST["nFonte"] : "";

conexao();

//Criar o comando sql
$sql_atualiza = "UPDATE docentes_gestao_planejamento_avaliacao SET data='$data', especificacao='$especificacao', fonte='$fonte' WHERE id='$Id'";
