        ...
        <table border="0">
            ...
            <tbody>
                ...
                while ($res = mysql_fetch_assoc($resultado)) {
                    ...
                    '<td>' . $res['nome'] . '</td>' .
                    '<td>' .
                    '<form style="display: inline;" method="post" action="docente_detalhes.php" > <input style="display: none;" type="text" name="matricula_uefs" value="' . $res['matricula_uefs'] . '">'
                    . '<button type="submit" class="btn btn-warning">&nbspExibir&nbsp </button> </form>' .
                    '<form style="display: inline;" method="post" action="bd_docente_excluir_cadastro.php" > <input type="text" style="display: none;" name="matricula_uefs" value="' . $res['matricula_uefs'] . '">'
