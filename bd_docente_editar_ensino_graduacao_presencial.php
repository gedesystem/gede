...
//Criar o comando sql
$sql_atualiza = "UPDATE docentes_ensino_graduacao_presencial SET data='$data', fonte='$fonte', observacoes='$observacoes' WHERE id_curso_presencial='$Id'";
...
header("refresh: 2; url=modulo_professores");
?>