...
<section>
    ...
    <form method="post" action="bd_docente_editar_extensao.php">

        <h2 class="Titulo">Editar Informações de Extensão de Docente</h2>
        ...
        <p>Início:
            <input type="text" class="form-control" id="iData" name="nData" required="required"
                   ...
                   placeholder="Data de início do projeto de extensão. Exemplo: 30/02/2016"
        ...
        <p>Fim:
            <input type="text" class="form-control" id="iDataFim" name="nDataFim"
                   pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$"
                   placeholder="Data do fim do projeto de extensão. Exemplo: 30/02/2017"
