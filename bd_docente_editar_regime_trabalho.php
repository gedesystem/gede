...
$regime = isset($_POST["nTipo"]) ? $_POST["nTipo"] : "";
...
//Criar o comando sql
$sql_atualiza = "UPDATE docentes_regime_trabalho SET data='$data', regime='$regime', fonte='$fonte', observacoes='$observacoes' WHERE id='$Id'";
